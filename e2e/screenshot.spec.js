...
test('demo page screenshot test', async ({ page, browserName }) => {
    ...
    if (wcLoaded) {
        ...
        await page.screenshot({ path: `./e2e/master_${browserName}_.png`, fullPage: true });
        expect(await page.screenshot({ fullPage: true })).toMatchSnapshot(`./e2e/master_${browserName}_.png`);
    }
});